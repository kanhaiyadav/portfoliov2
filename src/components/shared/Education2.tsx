...
const Education2 = () => {
    return (
        <section className="container w-full mx-auto flex-col-center pt-[100px] flex-col-center">
            <motion.div
            ...
            >
                ...
                <motion.svg
                    className={`w-[300px] md:w-[400px] xl:w-[500px] mt-8 md:my-6 xl:my-8`}
                    width="860"
                    viewBox="0 0 860 112"
                    fill="none"
                ...
                {education.map((institute, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                <div className="relative w-full h-full bg-gradient-to-t from-black to-transparent flex flex-col rounded-[8px] p-[10px] md:p-[20px]">
                                    <div className="flex-1" aria-hidden></div>
                                    <div className="flex items-center gap-4 w-full">
                                        <img
                                            src={institute.icon}
                                            alt=""
                                            className="h-[70px] rounded-full absolute sm:static top-4 left-0"
                                        />
                                        <div className="w-full">
                                            ...
                                            <div className="flex flex-col sm:flex-row gap-1 md:gap-8 mt-2 overflow-hidden">
                                                <a
                                                    href={
                                                        institute.officialWebsite
                                                    }
                                                    className="flex-center gap-1 hover:underline whitespace-nowrap text-sm md:text-md cursor-pointer text-primary"
                                                >
                                                    Official Website{" "}
                                                    <HiOutlineExternalLink />
                                                </a>
                                                <span className="flex-center gap-1 hover:underline whitespace-nowrap text-sm md:text-md">
                                                    <span className="text-primary font-medium">
                                                        Score:
                                                    </span>{" "}
                                                    {institute.score}
                                                </span>
                                                <p className="flex-center gap-1 hover:underline text-sm md:text-md ">
                                                    <span className="text-primary font-medium">
                                                        Degree/Standard:
                                                    </span>{" "}
                                                    <span>
