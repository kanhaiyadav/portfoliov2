    ...
    return (
        ...
        >
            <div className="w-fit flex flex-col items-center mt-[-100px] h-fit">
                <h1 className="text-2xl md:text-3xl lg:text-4xl text-gray-300 md:text-gray-500">
                    Hello I'm
                </h1>
                ...
                >
                    <motion.path
                        ...
                        //   stroke="gray"
                        className="stroke-gray-300 md:stroke-gray-900 stroke-[4]"
                        stroke-width="3"
                ...
                >
                    <p className="text-gray-300 md:text-gray-900 m-auto text-center text-sm xs:text-lg md:text-2xl">
