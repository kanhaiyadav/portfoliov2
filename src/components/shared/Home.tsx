...
import { scrollToParallaxSection } from "@/lib/utils";
    ...
    return (
        ...
        >
            <div className="w-fit flex flex-col items-center mt-[-100px] h-fit">
                <h1 className="text-2xl md:text-3xl lg:text-4xl text-white md:text-black">
                    Hello I'm
                </h1>
                <h1 className="text-primary/90 text-5xl md:text-7xl lg:text-8xl font-light">
                    ...
                    <span className="font-pixel text-[#00ffa6]">
                        {text}
                    </span>
                    <span className="text-secondary text-4xl md:text-6xl lg:text-7xl font-sans">{'" }'}</span>
                </h1>
                ...
                >
                    <motion.path
                        ...
                        //   stroke="gray"
                        className="stroke-gray-300 md:stroke-black stroke-[4]"
                        stroke-width="3"
                ...
                >
                    <p className="text-gray-300 md:text-black m-auto text-center text-sm xs:text-lg md:text-2xl">
                        Building the web, end to end
                    </p>
                    <div className="flex justify-center gap-2 xs:gap-4 items-center">
                        <div className="flex items-center gap-2 py-2 xs:py-3 px-4 xs:px-6 text-base outline outline-3 outline-secondary bg-transparent text-secondary  hover:text-white rounded-sm font-sans font-semibold horizontal-button relative"
                            onClick={() => {
                                setType("pdf");
                                setData({
                                    title: "My Resume",
                        ...
                        <button
                            ...
                            onClick={() => {
                                scrollToParallaxSection(parallaxRef, "contact");
                            }}
                        >
                            Hire Me
                        </button>
