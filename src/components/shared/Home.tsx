...
const Home = () => {
    ...
    return (
        <div className="w-full ml-[250px] flex flex-col pt-[100px] h-screen">
            ...
            <motion.div
                className="max-w-[600px] flex flex-col gap-8"
            ...
            >
                <p className="text-gray-500">
                    I am immersed in the world of web development, specializing
                    in the MERN stack (MongoDB, Express.js, React, Node.js).
                    <br /> My enthusiasm for exploring and mastering new
                    technologies drives me to constantly expand my skill set.
                    Currently, I am delving into the powerful capabilities of
                    Next.js to further elevate my development expertise.
                </p>
