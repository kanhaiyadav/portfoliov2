    ...
    return (
        <section className="w-full h-screen px-[100px] flex flex-col gap-4 py-4">
            ...
            <div className="flex-1 flex items-center justify-between gap-10">
                ...
                >
                    <div className="relative z-1 bg-black bg-opacity-50 h-full w-full flex flex-col justify-end rounded-xl p-4">
                ...
                <Card className="h-full max-w-[400px] bg-primary/5">
                    <CardHeader>
                        ...
                        <CardDescription>
                            neccessary details about the institution, degree.
                        </CardDescription>
                    </CardHeader>
